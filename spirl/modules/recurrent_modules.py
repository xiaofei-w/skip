...
class CustomLSTM(nn.Module):
    ...
    def forward(self, inputs, length, initial_inputs=None, static_inputs=None):
        ...
        # self.cell.reset(inputs['cell_input'].shape[0]) #change
...
class CustomLSTMCell(BaseCell):
    ...
    def reset(self, batch_size=0):
        ...
        # if batch_size == 0:
        #     batch_size = self._hp.batch_size # change
        # self.hidden_var = torch.zeros(batch_size, self.get_state_size(), device=self._hp.device)
