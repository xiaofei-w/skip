...
def get_args():
    ...
    # prior learning with human-in-loop
    parser.add_argument('--soft_train', default=True, type=bool,
                        help='using soft weigth scale to train the skill prior')
    parser.add_argument('--learn_human_ratio', default=0.1, type=float,
                        help='percent of data used to train the generalized human teacher')
    parser.add_argument('--train_epoch_from_human', default=25, type=int,
                        help='number of updates per training log') 
    parser.add_argument('--mixed_data', default=True, type=bool,
                        help='learning from noisy offline dataset')
